  ...
  return (
    ...
    <div className=" mt-8 sm:mx-6">
      ...
      <div className=" text-right mt-16">
        <button onClick={() => navigate(`/dashboard/settings/edittermcondition?id=${termsConditon?.data?.attributes?._id}`)} className=" h-[44px] w-full sm:w-[260px] !text-white !bg-primary rounded-[8px]">Edit</button>

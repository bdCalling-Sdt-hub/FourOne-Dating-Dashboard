    ...
    <div className="mt-8 sm:mx-6">
      ...
      <div>
        <div>
          ...
          <div
            onClick={showModal}
            className="mt-8 pl-4 cursor-pointer flex justify-between bg-[#F7F7F7] hover:bg-primary hover:text-white rounded items-center w-full h-[75px]"
          >
                ...
                {isForgotPassword && !isOtpSent && (
                  <>
                    ...
                    <div className="flex justify-between">
                      ...
                      <button
                        type="submit"
                        className="text-white font-semibold bg-primary hover:bg-primary rounded-lg p-2 h-12"
                      >
                        Send OTP
                      </button>
                    </div>
                ...
                {!isForgotPassword && (
                  <>
                    ...
                    <Form.Item>
                      <button
                        type="submit"
                        className="w-full text-white font-semibold bg-primary hover:bg-primary rounded-lg p-2 h-12"
                      >
                        Change Password
                      </button>
                    </Form.Item>

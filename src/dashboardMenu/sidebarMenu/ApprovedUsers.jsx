      ...
      <Modal open={isModalOpen} footer={null} onCancel={closeModal} centered>
        {selectedUser && (
          <>
            ...
            <p className="py-3 flex items-center justify-between"><strong>Name:</strong> {selectedUser.fullName}</p>
            <p className="py-3 flex items-center justify-between"><strong>Email:</strong> {selectedUser.email}</p>
            <p className="py-3 flex items-center justify-between"><strong>Phone:</strong> {selectedUser.phoneNumber || "N/A"}</p>
            <p className="py-3 flex items-center justify-between"><strong>Subscription:</strong> {selectedUser.subscription}</p>
            <p className="py-3 flex items-center justify-between"><strong>Joined:</strong> {moment(selectedUser.createdAt).format("DD MMMM, YYYY")}</p>
            <div className="flex items-center justify-center mt-10">
              <button className="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded">Remove </button>
            </div>
          </>
        )}
      </Modal>

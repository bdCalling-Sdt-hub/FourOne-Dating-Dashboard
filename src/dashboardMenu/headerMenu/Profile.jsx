...
const Profile = () => {
  ...
  return (
    <div className="md:p-4 mt-5 sm:mt-0">
      ...
      >
        <div onClick={() => navigate(`/dashboard/editprofile`)} className="w-48 !bg-primary !text-white py-3 px-6 rounded-lg cursor-pointer flex justify-center items-center gap-2 ">
          <FaEdit size={17} />
          <p>Edit Profile</p>
        </div>
      </div>
